...
import { getMockProject, storeMockProject, shouldUseMockOrchestrator } from "@/lib/orchestrator/mock";
...
export async function GET(
  ...
  try {
    ...
    return NextResponse.json({ project: toProjectPayload(projectDoc) });
  } catch (error) {
